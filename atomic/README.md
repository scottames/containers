...
A custom Fedora Atomic container image dagger module heavily customized for my
personal use.

> [!NOTE] Interested in making your own? Create an issue, we can work together
> to build a proper template.

Dagger is used to build and publish the image. The heavy lifting behind Fedora
Atomic images is done by the Fedora and Universal Blue communities.
