...
import (
	...
	"dagger/toolbox-fedora/internal/querybuilder"
	"dagger/toolbox-fedora/internal/telemetry"
)
...
// The `DistroboxID` scalar type represents an identifier for an object of type Distrobox.
type DistroboxID string
...
type Distrobox struct {
	...
	findStringSubmatchInFile *string
	id                       *DistroboxID
}

func (r *Distrobox) WithGraphQLQuery(q *querybuilder.Selection) *Distrobox {
	return &Distrobox{
		query: q,
	}
}

// DistroboxContainerWithDistroboxClonedToTmpOpts contains options for Distrobox.ContainerWithDistroboxClonedToTmp
type DistroboxContainerWithDistroboxClonedToTmpOpts struct {
	//
...
func (r *Distrobox) ContainerWithDistroboxClonedToTmp(opts ...DistroboxContainerWithDistroboxClonedToTmpOpts) *Container {
	q := r.query.Select("containerWithDistroboxClonedToTmp")
	for i := len(opts) - 1; i >= 0; i-- {
		...
		if !querybuilder.IsZeroValue(opts[i].Destination) {
			q = q.Arg("destination", opts[i].Destination)
		}
	}
...
// DistroboxContainerWithFileFromURLOpts contains options for Distrobox.ContainerWithFileFromURL
type DistroboxContainerWithFileFromURLOpts struct {
	//
...
func (r *Distrobox) ContainerWithFileFromURL(url string, opts ...DistroboxContainerWithFileFromURLOpts) *Container {
	q := r.query.Select("containerWithFileFromUrl")
	for i := len(opts) - 1; i >= 0; i-- {
		// `from` optional argument
		if !querybuilder.IsZeroValue(opts[i].From) {
			q = q.Arg("from", opts[i].From)
...
func (r *Distrobox) FindStringSubmatchInFile(ctx context.Context, file *File, regex string) (string, error) {
	assertNotNil("file", file)
	if r.findStringSubmatchInFile != nil {
		return *r.findStringSubmatchInFile, nil
	}
	q := r.query.Select("findStringSubmatchInFile")
	q = q.Arg("file", file)
	q = q.Arg("regex", regex)
...
// DistroboxHostExecFileOpts contains options for Distrobox.HostExecFile
type DistroboxHostExecFileOpts struct {
	//
	// container to use to clone the distrobox project
	//   note: `git` is expected to be the entrypoint!
	//
...
func (r *Distrobox) HostExecFile(opts ...DistroboxHostExecFileOpts) *File {
	q := r.query.Select("hostExecFile")
	for i := len(opts) - 1; i >= 0; i-- {
		// `from` optional argument
		if !querybuilder.IsZeroValue(opts[i].From) {
			q = q.Arg("from", opts[i].From)
...
// DistroboxHostSpawnFileOpts contains options for Distrobox.HostSpawnFile
type DistroboxHostSpawnFileOpts struct {
	//
...
// release
func (r *Distrobox) HostSpawnFile(opts ...DistroboxHostSpawnFileOpts) *File {
	q := r.query.Select("hostSpawnFile")
	for i := len(opts) - 1; i >= 0; i-- {
		// `from` optional argument
		if !querybuilder.IsZeroValue(opts[i].From) {
			q = q.Arg("from", opts[i].From)
...
// A unique identifier for this Distrobox.
func (r *Distrobox) ID(ctx context.Context) (DistroboxID, error) {
	if r.id != nil {
		return *r.id, nil
	}
	q := r.query.Select("id")

	var response DistroboxID
...
// XXX_GraphQLType is an internal function. It returns the native GraphQL type name
func (r *Distrobox) XXX_GraphQLType() string {
	return "Distrobox"
}

// XXX_GraphQLIDType is an internal function. It returns the native GraphQL type name for the ID of this object
func (r *Distrobox) XXX_GraphQLIDType() string {
	return "DistroboxID"
}

// XXX_GraphQLID is an internal function. It returns the underlying type ID
func (r *Distrobox) XXX_GraphQLID(ctx context.Context) (string, error) {
	id, err := r.ID(ctx)
	if err != nil {
		return "", err
	}
...
func (r *Distrobox) MarshalJSON() ([]byte, error) {
	id, err := r.ID(marshalCtx)
	if err != nil {
		return nil, err
	}
...
func (r *Distrobox) UnmarshalJSON(bs []byte) error {
	var id string
	err := json.Unmarshal(bs, &id)
	if err != nil {
		return err
	}
	*r = *dag.LoadDistroboxFromID(DistroboxID(id))
	return nil
}
...
type Fedora struct {
	...
	containerReleaseVersionFromLabel *string
	containerVersionFromLabel        *string
	date                             *string
	getBaseImage                     *string
	id                               *FedoraID
	org                              *string
...
type WithFedoraFunc func(r *Fedora) *Fedora

// With calls the provided function with current Fedora.
//
// This is useful for reusability and readability by not breaking the calling chain.
func (r *Fedora) With(f WithFedoraFunc) *Fedora {
	return f(r)
}

func (r *Fedora) WithGraphQLQuery(q *querybuilder.Selection) *Fedora {
	return &Fedora{
		query: q,
	}
}

func (r *Fedora) BaseImage(ctx context.Context) (string, error) {
	if r.baseImage != nil {
...
func (r *Fedora) BaseImageVersion(ctx context.Context) (string, error) {
	if r.baseImageVersion != nil {
		return *r.baseImageVersion, nil
	}
	q := r.query.Select("baseImageVersion")
...
func (r *Fedora) Container() *Container {
...
type FedoraContainerAddressOpts struct {
	Org string
...
// container address
func (r *Fedora) ContainerAddress(ctx context.Context, registry string, variant string, tag string, opts ...FedoraContainerAddressOpts) (string, error) {
	if r.containerAddress != nil {
		return *r.containerAddress, nil
	}
	q := r.query.Select("containerAddress")
	for i := len(opts) - 1; i >= 0; i-- {
		// `org` optional argument
		if !querybuilder.IsZeroValue(opts[i].Org) {
			q = q.Arg("org", opts[i].Org)
		}
		// `suffix` optional argument
		if !querybuilder.IsZeroValue(opts[i].Suffix) {
			q = q.Arg("suffix", opts[i].Suffix)
		}
	}
...
func (r *Fedora) ContainerFrom(from string) *Container {
	q := r.query.Select("containerFrom")
	q = q.Arg("from", from)
...
type FedoraContainerReleaseVersionFromLabelOpts struct {
	//
...
//     parsed out
func (r *Fedora) ContainerReleaseVersionFromLabel(ctx context.Context, opts ...FedoraContainerReleaseVersionFromLabelOpts) (string, error) {
	if r.containerReleaseVersionFromLabel != nil {
		return *r.containerReleaseVersionFromLabel, nil
	}
	q := r.query.Select("containerReleaseVersionFromLabel")
	for i := len(opts) - 1; i >= 0; i-- {
...
type FedoraContainerVersionFromLabelOpts struct {
	//
	// Container to use to determine the release version from
	//
	Ctr *Container
...
func (r *Fedora) ContainerVersionFromLabel(ctx context.Context, opts ...FedoraContainerVersionFromLabelOpts) (string, error) {
	if r.containerVersionFromLabel != nil {
		return *r.containerVersionFromLabel, nil
	}
	q := r.query.Select("containerVersionFromLabel")
	for i := len(opts) - 1; i >= 0; i-- {
		// `ctr` optional argument
		if !querybuilder.IsZeroValue(opts[i].Ctr) {
			q = q.Arg("ctr", opts[i].Ctr)
...
func (r *Fedora) Date(ctx context.Context) (string, error) {
	if r.date != nil {
		return *r.date, nil
	}
...
type FedoraDefaultTagsOpts struct {
	//
...
func (r *Fedora) DefaultTags(ctx context.Context, opts ...FedoraDefaultTagsOpts) ([]string, error) {
	q := r.query.Select("defaultTags")
	for i := len(opts) - 1; i >= 0; i-- {
...
func (r *Fedora) Digests(ctx context.Context) ([]string, error) {
	q := r.query.Select("digests")
...
func (r *Fedora) Directories(ctx context.Context) ([]FedoraDirectoryFromSource, error) {
	q := r.query.Select("directories")

	q = q.Select("id")

	type directories struct {
		Id FedoraDirectoryFromSourceID
	}

	convert := func(fields []directories) []FedoraDirectoryFromSource {
		out := []FedoraDirectoryFromSource{}

		for i := range fields {
			val := FedoraDirectoryFromSource{id: &fields[i].Id}
			val.query = q.Root().Select("loadFedoraDirectoryFromSourceFromID").Arg("id", fields[i].Id)
			out = append(out, val)
		}
...
func (r *Fedora) ExecPost(ctx context.Context) ([][]string, error) {
	q := r.query.Select("execPost")
...
func (r *Fedora) ExecPre(ctx context.Context) ([][]string, error) {
	q := r.query.Select("execPre")
...
func (r *Fedora) ExecScriptPost(ctx context.Context) ([]File, error) {
	q := r.query.Select("execScriptPost")

	q = q.Select("id")

	type execScriptPost struct {
		Id FileID
	}

	convert := func(fields []execScriptPost) []File {
		out := []File{}
...
func (r *Fedora) ExecScriptPre(ctx context.Context) ([]File, error) {
	q := r.query.Select("execScriptPre")

	q = q.Select("id")

	type execScriptPre struct {
		Id FileID
	}

	convert := func(fields []execScriptPre) []File {
		out := []File{}
...
func (r *Fedora) Files(ctx context.Context) ([]FedoraFileFromSource, error) {
	q := r.query.Select("files")

	q = q.Select("id")

	type files struct {
		Id FedoraFileFromSourceID
	}

	convert := func(fields []files) []FedoraFileFromSource {
		out := []FedoraFileFromSource{}

		for i := range fields {
			val := FedoraFileFromSource{id: &fields[i].Id}
			val.query = q.Root().Select("loadFedoraFileFromSourceFromID").Arg("id", fields[i].Id)
			out = append(out, val)
		}
...
func (r *Fedora) GetBaseImage(ctx context.Context) (string, error) {
	if r.getBaseImage != nil {
		return *r.getBaseImage, nil
	}
	q := r.query.Select("getBaseImage")
...
// A unique identifier for this Fedora.
func (r *Fedora) ID(ctx context.Context) (FedoraID, error) {
	if r.id != nil {
		return *r.id, nil
	}
	q := r.query.Select("id")

	var response FedoraID
...
// XXX_GraphQLType is an internal function. It returns the native GraphQL type name
func (r *Fedora) XXX_GraphQLType() string {
	return "Fedora"
}

// XXX_GraphQLIDType is an internal function. It returns the native GraphQL type name for the ID of this object
func (r *Fedora) XXX_GraphQLIDType() string {
	return "FedoraID"
}

// XXX_GraphQLID is an internal function. It returns the underlying type ID
func (r *Fedora) XXX_GraphQLID(ctx context.Context) (string, error) {
	id, err := r.ID(ctx)
	if err != nil {
		return "", err
	}
...
func (r *Fedora) MarshalJSON() ([]byte, error) {
	id, err := r.ID(marshalCtx)
	if err != nil {
		return nil, err
	}
...
func (r *Fedora) UnmarshalJSON(bs []byte) error {
	var id string
	err := json.Unmarshal(bs, &id)
	if err != nil {
		return err
	}
	*r = *dag.LoadFedoraFromID(FedoraID(id))
	return nil
}

func (r *Fedora) Labels(ctx context.Context) ([]FedoraContainerLabel, error) {
	q := r.query.Select("labels")

	q = q.Select("id")

	type labels struct {
		Id FedoraContainerLabelID
	}

	convert := func(fields []labels) []FedoraContainerLabel {
		out := []FedoraContainerLabel{}

		for i := range fields {
			val := FedoraContainerLabel{id: &fields[i].Id}
			val.query = q.Root().Select("loadFedoraContainerLabelFromID").Arg("id", fields[i].Id)
			out = append(out, val)
		}
...
func (r *Fedora) Org(ctx context.Context) (string, error) {
	if r.org != nil {
		return *r.org, nil
	}
	q := r.query.Select("org")
...
func (r *Fedora) PackageGroupsInstalled(ctx context.Context) ([]string, error) {
	q := r.query.Select("packageGroupsInstalled")
...
func (r *Fedora) PackageGroupsRemoved(ctx context.Context) ([]string, error) {
	q := r.query.Select("packageGroupsRemoved")
...
func (r *Fedora) PackagesInstalled(ctx context.Context) ([]string, error) {
	q := r.query.Select("packagesInstalled")
...
func (r *Fedora) PackagesRemoved(ctx context.Context) ([]string, error) {
	q := r.query.Select("packagesRemoved")
...
func (r *Fedora) PackagesSwapped(ctx context.Context) ([]FedoraSwap, error) {
	q := r.query.Select("packagesSwapped")

	q = q.Select("id")

	type packagesSwapped struct {
		Id FedoraSwapID
	}

	convert := func(fields []packagesSwapped) []FedoraSwap {
		out := []FedoraSwap{}

		for i := range fields {
			val := FedoraSwap{id: &fields[i].Id}
			val.query = q.Root().Select("loadFedoraSwapFromID").Arg("id", fields[i].Id)
			out = append(out, val)
		}

		return out
	}
	var response []packagesSwapped
...
func (r *Fedora) Registry(ctx context.Context) (string, error) {
	if r.registry != nil {
...
func (r *Fedora) ReleaseVersion(ctx context.Context) (string, error) {
	if r.releaseVersion != nil {
		return *r.releaseVersion, nil
	}
	q := r.query.Select("releaseVersion")
...
func (r *Fedora) Repos(ctx context.Context) ([]FedoraRepo, error) {
	q := r.query.Select("repos")
	...
	convert := func(fields []repos) []FedoraRepo {
		out := []FedoraRepo{}

		for i := range fields {
			val := FedoraRepo{id: &fields[i].Id}
			val.query = q.Root().Select("loadFedoraRepoFromID").Arg("id", fields[i].Id)
			out = append(out, val)
		}
...
func (r *Fedora) Suffix(ctx context.Context) (string, error) {
	if r.suffix != nil {
		return *r.suffix, nil
	}
...
func (r *Fedora) Tag(ctx context.Context) (string, error) {
	if r.tag != nil {
		return *r.tag, nil
	}
...
func (r *Fedora) Variant(ctx context.Context) (string, error) {
	if r.variant != nil {
		return *r.variant, nil
	}
	q := r.query.Select("variant")
...
func (r *Fedora) WithDescription(description string) *Fedora {
...
func (r *Fedora) WithDirectory(destination string, directory *Directory) *Fedora {
	assertNotNil("directory", directory)
	q := r.query.Select("withDirectory")
	q = q.Arg("destination", destination)
	q = q.Arg("directory", directory)
...
func (r *Fedora) WithExec(command []string, prePackages bool) *Fedora {
	q := r.query.Select("withExec")
	q = q.Arg("command", command)
	q = q.Arg("prePackages", prePackages)
...
func (r *Fedora) WithExecScripts(scripts []*File, prePackages bool) *Fedora {
	q := r.query.Select("withExecScripts")
	q = q.Arg("scripts", scripts)
	q = q.Arg("prePackages", prePackages)
...
func (r *Fedora) WithFile(destination string, file *File) *Fedora {
	assertNotNil("file", file)
	q := r.query.Select("withFile")
	q = q.Arg("destination", destination)
	q = q.Arg("file", file)
...
// map
func (r *Fedora) WithLabel(name string, value string) *Fedora {
	q := r.query.Select("withLabel")
	q = q.Arg("name", name)
	q = q.Arg("value", value)
...
func (r *Fedora) WithPackageGroupsInstalled(groups []string) *Fedora {
	q := r.query.Select("withPackageGroupsInstalled")
	q = q.Arg("groups", groups)
...
//
//	note: not supported on ostree-based images, will be skipped
func (r *Fedora) WithPackageGroupsRemoved(groups []string) *Fedora {
	q := r.query.Select("withPackageGroupsRemoved")
	q = q.Arg("groups", groups)
...
// Container image.
func (r *Fedora) WithPackagesInstalled(packages []string) *Fedora {
	q := r.query.Select("withPackagesInstalled")
...
// image.
func (r *Fedora) WithPackagesRemoved(packages []string) *Fedora {
	q := r.query.Select("withPackagesRemoved")
	q = q.Arg("packages", packages)
...
func (r *Fedora) WithPackagesSwapped(remove string, install string) *Fedora {
	q := r.query.Select("withPackagesSwapped")
	q = q.Arg("remove", remove)
	q = q.Arg("install", install)
...
func (r *Fedora) WithReposFromUrls(urls []string, keep bool) *Fedora {
	q := r.query.Select("withReposFromUrls")
	q = q.Arg("urls", urls)
	q = q.Arg("keep", keep)
...
type FedoraContainerLabel struct {
	query *querybuilder.Selection
...
func (r *FedoraContainerLabel) WithGraphQLQuery(q *querybuilder.Selection) *FedoraContainerLabel {
	return &FedoraContainerLabel{
		query: q,
	}
}

// A unique identifier for this FedoraContainerLabel.
func (r *FedoraContainerLabel) ID(ctx context.Context) (FedoraContainerLabelID, error) {
	if r.id != nil {
		return *r.id, nil
	}
	q := r.query.Select("id")

	var response FedoraContainerLabelID
...
// XXX_GraphQLType is an internal function. It returns the native GraphQL type name
func (r *FedoraContainerLabel) XXX_GraphQLType() string {
	return "FedoraContainerLabel"
}

// XXX_GraphQLIDType is an internal function. It returns the native GraphQL type name for the ID of this object
func (r *FedoraContainerLabel) XXX_GraphQLIDType() string {
	return "FedoraContainerLabelID"
}

// XXX_GraphQLID is an internal function. It returns the underlying type ID
func (r *FedoraContainerLabel) XXX_GraphQLID(ctx context.Context) (string, error) {
	id, err := r.ID(ctx)
	if err != nil {
		return "", err
	}
...
func (r *FedoraContainerLabel) MarshalJSON() ([]byte, error) {
	id, err := r.ID(marshalCtx)
	if err != nil {
		return nil, err
	}
...
func (r *FedoraContainerLabel) UnmarshalJSON(bs []byte) error {
	var id string
	err := json.Unmarshal(bs, &id)
	if err != nil {
		return err
	}
	*r = *dag.LoadFedoraContainerLabelFromID(FedoraContainerLabelID(id))
	return nil
}

func (r *FedoraContainerLabel) Name(ctx context.Context) (string, error) {
	if r.name != nil {
		return *r.name, nil
	}
	q := r.query.Select("name")
...
func (r *FedoraContainerLabel) Value(ctx context.Context) (string, error) {
	if r.value != nil {
		return *r.value, nil
	}
	q := r.query.Select("value")
...
type FedoraDirectoryFromSource struct {
	query *querybuilder.Selection
...
func (r *FedoraDirectoryFromSource) WithGraphQLQuery(q *querybuilder.Selection) *FedoraDirectoryFromSource {
	return &FedoraDirectoryFromSource{
		query: q,
	}
}

func (r *FedoraDirectoryFromSource) Destination(ctx context.Context) (string, error) {
	if r.destination != nil {
		return *r.destination, nil
	}
	q := r.query.Select("destination")
...
// A unique identifier for this FedoraDirectoryFromSource.
func (r *FedoraDirectoryFromSource) ID(ctx context.Context) (FedoraDirectoryFromSourceID, error) {
	if r.id != nil {
		return *r.id, nil
	}
	q := r.query.Select("id")

	var response FedoraDirectoryFromSourceID
...
// XXX_GraphQLType is an internal function. It returns the native GraphQL type name
func (r *FedoraDirectoryFromSource) XXX_GraphQLType() string {
	return "FedoraDirectoryFromSource"
}

// XXX_GraphQLIDType is an internal function. It returns the native GraphQL type name for the ID of this object
func (r *FedoraDirectoryFromSource) XXX_GraphQLIDType() string {
	return "FedoraDirectoryFromSourceID"
}

// XXX_GraphQLID is an internal function. It returns the underlying type ID
func (r *FedoraDirectoryFromSource) XXX_GraphQLID(ctx context.Context) (string, error) {
	id, err := r.ID(ctx)
	if err != nil {
		return "", err
	}
...
func (r *FedoraDirectoryFromSource) MarshalJSON() ([]byte, error) {
	id, err := r.ID(marshalCtx)
	if err != nil {
		return nil, err
	}
...
func (r *FedoraDirectoryFromSource) UnmarshalJSON(bs []byte) error {
	var id string
	err := json.Unmarshal(bs, &id)
	if err != nil {
		return err
	}
	*r = *dag.LoadFedoraDirectoryFromSourceFromID(FedoraDirectoryFromSourceID(id))
	return nil
}

func (r *FedoraDirectoryFromSource) Source() *Directory {
	q := r.query.Select("source")
...
// image at the Destination
type FedoraFileFromSource struct {
	query *querybuilder.Selection
...
func (r *FedoraFileFromSource) WithGraphQLQuery(q *querybuilder.Selection) *FedoraFileFromSource {
	return &FedoraFileFromSource{
		query: q,
	}
}

func (r *FedoraFileFromSource) Destination(ctx context.Context) (string, error) {
	if r.destination != nil {
		return *r.destination, nil
	}
	q := r.query.Select("destination")
...
// A unique identifier for this FedoraFileFromSource.
func (r *FedoraFileFromSource) ID(ctx context.Context) (FedoraFileFromSourceID, error) {
	if r.id != nil {
		return *r.id, nil
	}
	q := r.query.Select("id")

	var response FedoraFileFromSourceID
...
// XXX_GraphQLType is an internal function. It returns the native GraphQL type name
func (r *FedoraFileFromSource) XXX_GraphQLType() string {
	return "FedoraFileFromSource"
}

// XXX_GraphQLIDType is an internal function. It returns the native GraphQL type name for the ID of this object
func (r *FedoraFileFromSource) XXX_GraphQLIDType() string {
	return "FedoraFileFromSourceID"
}

// XXX_GraphQLID is an internal function. It returns the underlying type ID
func (r *FedoraFileFromSource) XXX_GraphQLID(ctx context.Context) (string, error) {
	id, err := r.ID(ctx)
	if err != nil {
		return "", err
	}
...
func (r *FedoraFileFromSource) MarshalJSON() ([]byte, error) {
	id, err := r.ID(marshalCtx)
	if err != nil {
		return nil, err
	}
...
func (r *FedoraFileFromSource) UnmarshalJSON(bs []byte) error {
	var id string
	err := json.Unmarshal(bs, &id)
	if err != nil {
		return err
	}
	*r = *dag.LoadFedoraFileFromSourceFromID(FedoraFileFromSourceID(id))
	return nil
}

func (r *FedoraFileFromSource) Source() *File {
	q := r.query.Select("source")
...
func (r *FedoraRepo) WithGraphQLQuery(q *querybuilder.Selection) *FedoraRepo {
	return &FedoraRepo{
		query: q,
	}
}

func (r *FedoraRepo) FileName(ctx context.Context) (string, error) {
	if r.fileName != nil {
...
// A unique identifier for this FedoraRepo.
func (r *FedoraRepo) ID(ctx context.Context) (FedoraRepoID, error) {
	if r.id != nil {
		return *r.id, nil
	}
	q := r.query.Select("id")

	var response FedoraRepoID
...
// XXX_GraphQLType is an internal function. It returns the native GraphQL type name
func (r *FedoraRepo) XXX_GraphQLType() string {
	return "FedoraRepo"
}

// XXX_GraphQLIDType is an internal function. It returns the native GraphQL type name for the ID of this object
func (r *FedoraRepo) XXX_GraphQLIDType() string {
	return "FedoraRepoID"
}

// XXX_GraphQLID is an internal function. It returns the underlying type ID
func (r *FedoraRepo) XXX_GraphQLID(ctx context.Context) (string, error) {
	id, err := r.ID(ctx)
	if err != nil {
		return "", err
	}
...
func (r *FedoraRepo) MarshalJSON() ([]byte, error) {
	id, err := r.ID(marshalCtx)
	if err != nil {
		return nil, err
	}
...
func (r *FedoraRepo) UnmarshalJSON(bs []byte) error {
	var id string
	err := json.Unmarshal(bs, &id)
	if err != nil {
		return err
	}
	*r = *dag.LoadFedoraRepoFromID(FedoraRepoID(id))
	return nil
}

func (r *FedoraRepo) Keep(ctx context.Context) (bool, error) {
	if r.keep != nil {
		return *r.keep, nil
	}
	q := r.query.Select("keep")
...
func (r *FedoraRepo) URL(ctx context.Context) (string, error) {
	if r.url != nil {
		return *r.url, nil
	}
...
func (r *FedoraSwap) WithGraphQLQuery(q *querybuilder.Selection) *FedoraSwap {
	return &FedoraSwap{
		query: q,
	}
}

// A unique identifier for this FedoraSwap.
func (r *FedoraSwap) ID(ctx context.Context) (FedoraSwapID, error) {
	if r.id != nil {
		return *r.id, nil
	}
	q := r.query.Select("id")

	var response FedoraSwapID
...
// XXX_GraphQLType is an internal function. It returns the native GraphQL type name
func (r *FedoraSwap) XXX_GraphQLType() string {
	return "FedoraSwap"
}

// XXX_GraphQLIDType is an internal function. It returns the native GraphQL type name for the ID of this object
func (r *FedoraSwap) XXX_GraphQLIDType() string {
	return "FedoraSwapID"
}

// XXX_GraphQLID is an internal function. It returns the underlying type ID
func (r *FedoraSwap) XXX_GraphQLID(ctx context.Context) (string, error) {
	id, err := r.ID(ctx)
	if err != nil {
		return "", err
	}
...
func (r *FedoraSwap) MarshalJSON() ([]byte, error) {
	id, err := r.ID(marshalCtx)
	if err != nil {
		return nil, err
	}
...
func (r *FedoraSwap) UnmarshalJSON(bs []byte) error {
	var id string
	err := json.Unmarshal(bs, &id)
	if err != nil {
		return err
	}
	*r = *dag.LoadFedoraSwapFromID(FedoraSwapID(id))
	return nil
}

func (r *FedoraSwap) Install(ctx context.Context) (string, error) {
	if r.install != nil {
...
func (r *FedoraSwap) Remove(ctx context.Context) (string, error) {
	if r.remove != nil {
		return *r.remove, nil
	}
	q := r.query.Select("remove")
...
func (r *Client) Distrobox() *Distrobox {
	q := r.query.Select("distrobox")
...
func (r *Client) Fedora(opts ...FedoraOpts) *Fedora {
	q := r.query.Select("fedora")
	for i := len(opts) - 1; i >= 0; i-- {
		...
		// `variant` optional argument
		if !querybuilder.IsZeroValue(opts[i].Variant) {
			q = q.Arg("variant", opts[i].Variant)
		}
		// `suffix` optional argument
		if !querybuilder.IsZeroValue(opts[i].Suffix) {
			q = q.Arg("suffix", opts[i].Suffix)
...
// Load a Distrobox from its ID.
func (r *Client) LoadDistroboxFromID(id DistroboxID) *Distrobox {
	q := r.query.Select("loadDistroboxFromID")
	q = q.Arg("id", id)
...
// Load a FedoraContainerLabel from its ID.
func (r *Client) LoadFedoraContainerLabelFromID(id FedoraContainerLabelID) *FedoraContainerLabel {
	q := r.query.Select("loadFedoraContainerLabelFromID")
	q = q.Arg("id", id)
...
// Load a FedoraDirectoryFromSource from its ID.
func (r *Client) LoadFedoraDirectoryFromSourceFromID(id FedoraDirectoryFromSourceID) *FedoraDirectoryFromSource {
	q := r.query.Select("loadFedoraDirectoryFromSourceFromID")
	q = q.Arg("id", id)
...
// Load a FedoraFileFromSource from its ID.
func (r *Client) LoadFedoraFileFromSourceFromID(id FedoraFileFromSourceID) *FedoraFileFromSource {
	q := r.query.Select("loadFedoraFileFromSourceFromID")
	q = q.Arg("id", id)
...
// Load a Fedora from its ID.
func (r *Client) LoadFedoraFromID(id FedoraID) *Fedora {
	q := r.query.Select("loadFedoraFromID")
	q = q.Arg("id", id)
...
// Load a FedoraRepo from its ID.
func (r *Client) LoadFedoraRepoFromID(id FedoraRepoID) *FedoraRepo {
	q := r.query.Select("loadFedoraRepoFromID")
	q = q.Arg("id", id)
...
// Load a FedoraSwap from its ID.
func (r *Client) LoadFedoraSwapFromID(id FedoraSwapID) *FedoraSwap {
	q := r.query.Select("loadFedoraSwapFromID")
	q = q.Arg("id", id)
